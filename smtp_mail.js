...
var creator = function(data) {
  ...
  if(group == "PM"){
    gQ1 = "Project Management Question : " + data.pmQ1;
  }
  if(group == "Cu"){
    gQ1 = "Curator Question 1 : " + data.curatorQ1;
    gQ2 = "Curator Question 2 : " + data.curatorQ2;
  }
  if(group == "Cr"){
    gQ1 = "Creative Question : " + data.creativeQ1;
  }
